...
urlpatterns = patterns('bangladict.views',
    ...
    url(r'^accept_word/$', 'word_accept', name='dict_word_accept'),
    url(r'^(?P<dict_abbrev>\w+)/$', 'word_list', name='dict_word_list'),
    url(r'^(?P<dict_abbrev>\w+)/status/(?P<status>(new|rejected))/$', 'word_list',
        name='dict_word_list_status'),
    url(r'^comments/(?P<wid>\d+)/$', 'word_comments', name='dict_word_comments'),
    url(r'^(?P<dict_abbrev>\w+)/(?P<alpha>.{0,5})/$', 'word_list',
        name='dict_word_list_alpha'),
